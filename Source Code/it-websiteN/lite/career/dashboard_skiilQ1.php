<?php 
// $sql = "SELECT * FROM `sum_form`,data_career WHERE sum_form.career = data_career.career_name AND `user_id`= '$_SESSION_id' AND `date` = '$form_date' AND `side` = '$form_side' ORDER BY `sum_form`.`degree` ASC";
...
$sql = "SELECT * FROM MAPPING_STUDENT_REPORT AS R
  ...
  AND G.QUESTION_PART = '$form_side' ORDER BY R.MAPPING_STUDENT_REPORT_ID";
