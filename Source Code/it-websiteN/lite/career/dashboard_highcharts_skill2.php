...
<table id="datatableSkill" class="table table">
    ...
    <?php
    // $sql = "SELECT * FROM `sum_form`,data_career WHERE sum_form.career = data_career.career_name AND `user_id`= '$_SESSION_id' AND `date` = '$form_date' AND `type` = '$form_type2' AND `side` = '$form_side2' ORDER BY `sum_form`.`degree` ASC";
