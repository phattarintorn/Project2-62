  ...
  <body class="fix-header fix-sidebar card-no-border logo-center">
    <div class="preloader">
      <svg class="circular" viewBox="25 25 50 50">
        <circle class="path" cx="50" cy="50" r="20" fill="none" stroke-width="2" stroke-miterlimit="3" />
      </svg>
    </div>
              ...
              <div class="card-block ">
                <div class="card">
                  <div id="carouselExampleIndicators" class="carousel slide " data-ride="carousel">
                    <ol class="carousel-indicators" id="carouselCount"></ol>
                    <div id="imageHeaderSlide" class="carousel-inner card-img-top card-img-bottom text-center"></div>
              ...
              <div class="card-body little-logo text-center">
                <div class="card-block">
                  ...
                  <a href="https://www.facebook.com/ITSuranaree/" class="m-t-10 waves-effect waves-dark btn btn-info btn-md btn-rounded">
                    <i class="mdi mdi-facebook-box"></i> ติดตาม
                  </a>
                ...
                <div class="card card-white">
                  <div class="card-block">
                    <div class="card-body">
                      <div class="d-flex">
                        <div class="m-r-20 align-self-center">
                          <h1 class="text-black"><i class="ti-book"></i></h1>
                        </div>
                        <div>
              ...
              <div class="card  card-white">
                <div class="card-block">
                  <div class="card-body">
                    <div class="d-flex">
                      <div class="m-r-20 align-self-center">
                        <h1 class="text-black"><i class="ti-pie-chart"></i></h1>
                      </div>
                      <div>
                        <h3 class="card-title">Business Intelligence and Data Analytics</h3>
                        <h6 class="card-subtitle">ธุรกิจอัจฉริยะและการวิเคราะห์ข้อมูล</h6>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-12">
                  ...
                  <div class="card">
                    <div class="card-block ">
                      <div id="carouselBachelor" class="carousel slide " data-ride="carousel">
                        <ol class="carousel-indicators" id="carouselInfoBachelor"></ol>
                        <div id="imageInfoBachelorSlide" class="carousel-inner card-img-top card-img-bottom text-center"></div>
                  ...
                  <div class="card">
                    <div class="card-block ">
                      <div id="carouselGraduation" class="carousel slide " data-ride="carousel">
                        <ol class="carousel-indicators" id="carouselInfoGraduate"></ol>
                        <div id="imageInfoGraduationSlide" class="carousel-inner card-img-top card-img-bottom text-center"></div>
