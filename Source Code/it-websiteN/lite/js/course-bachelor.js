$(document).ready(function(){
  ...
  var numCountCourseBachelor = firebase.database().ref('statistic/course_bachelor_page').child(yearViewPage).child(monthViewPage).child('count');
  numCountCourseBachelor.on('value',snap=>{
    n = snap.val();
    ...
    $('#Suggestion_work').append(
      ...
      "</tr>"
        ...
        if(i==1){
                ...
                var rootRefBranch = topicRef.child("course/AddCourses").child('ปริญญาตรี').child(snapkey);
                ...
                $('#TitlePlan').text(snapkey);
                     ...
                     var DownloadPlan = topicRef.child("course/AddStudyplan").child('ปริญญาตรี').child(snapkey).child('Studyplan').child('file');
          ...
          rootRefBranch.on("child_added",snap => {
           ...
           $('#Branch_work').append(
              ...
              var Download = topicRef.child("course/AddDownload").child('ปริญญาตรี').child(snapkey);
          $('#Download_work').empty();
